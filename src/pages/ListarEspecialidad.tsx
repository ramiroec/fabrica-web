...
function ListarEspecialidad() {
  const [especialidades, setData] = useState<Especialidad[]>([]);
  ...
  return (
    <div>
      <ContentHeader title="Especialidades" />
              ...
              <div className="row">
                <div className="col-lg-9">
                  <h3 className="card-title">
                    Listado con Información de las Especialidades
                  </h3>
                </div>
                <div className="col-lg-3 text-right">
                  <Link className="btn btn-info" to="/especialidad/crear">
                    Crear Especialidad
                  </Link>
                </div>
              </div>
                  ...
                  <tbody>
                    {especialidades.map((especialidad, index) => (
                      <tr key={especialidad.id}>
                        ...
                        <td>{especialidad.observacion}</td>
                        <td>{especialidad.estado}</td>
                        <td>
                          <Link
                            className="icon-block"
                            to={`/especialidad/${especialidad.id}`}
                          >
