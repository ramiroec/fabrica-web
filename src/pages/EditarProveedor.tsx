...
const EditarProveedor = () => {
    ...
    const handleSubmit = (e: any) => {
        ...
        const updatedData = {
            ...
            nombre_fantasia: e.target.nombre_fantasia.value,
            ...
            nombre_contacto: e.target.nombre_contacto.value,
            estado: e.target.estado.value,
            email: e.target.email.value,
        };
        const api = authenticatedApi();
        api
            .put(`/proveedor/${id}`, updatedData)
            .then((res) => {
                console.log(res);
                toast.success("Guardado con éxito!");
                setTimeout(() => {
                    navigate("/configuracion/proveedor");
                }, 3000);
            })
            .catch((err) => {
                console.log(err);
