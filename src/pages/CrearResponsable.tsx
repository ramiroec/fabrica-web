...
const CrearResponsable = () => {
  ...
  const handleSubmit = (e: any) => {
    ...
    api.post("/responsable", updatedData)
      .then((res) => {
        ...
        setTimeout(() => {
          navigate(`/responsable/${res.data.id}`);  // Asegúrate de que res.data.id tiene el ID correcto
  ...
  return (
    <div>
      <ContentHeader title="Crear Responsable" />
      <section className="content">
        <div className="container-fluid">
          <div className="card card-info card-outline">
            <div className="card-header">
              <h3 className="card-title">Ingresar Información del Responsable</h3>
